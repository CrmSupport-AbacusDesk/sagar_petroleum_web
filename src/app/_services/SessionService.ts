        ...
        setSession(data: any) {
            ...
            .subscribe((data: any) => {
                if (data.token) {
                    ...
                    else if( this.users.access_level != 1)  
                    {
                        ...
                        else if(this.users.distributor==1)
                        {
                            home_page = '/distributor-list/:page'; 
                        }
                        else if(this.users.dealer==1)
                        {
                            home_page = '/dealer-list/:page'; 
                        }
                        else if(this.users.mechanic==1)
                        {
                            home_page = '/karigar-list/:page'; 
                        }
                        ...
                        {
                            home_page = '/faq-questionaire'; 
                        }    
                        else if(this.users.master==1)
                        {
                            home_page = '/productcategory-list'; 
                        } 
                        else{
