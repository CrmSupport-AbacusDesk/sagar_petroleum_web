...
@Component({
  ...
  templateUrl: './dsrupload.component.html',
  styleUrls: ['./dsrupload.component.scss']
})
export class DsruploadComponent implements OnInit {
...
constructor(public db: DatabaseService,public dialog: DialogComponent, public alrt:MatDialog,public dialogRef: MatDialogRef<DsruploadComponent>) { }
...
uploadCSV()
{
    ...
    this.db.fileData(this.formData, 'app_karigar/upload_bulk_dsr_details')
    .subscribe(d => {  
        this.loading = false;
