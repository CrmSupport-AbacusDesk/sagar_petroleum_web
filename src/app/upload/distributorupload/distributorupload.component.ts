...
@Component({
  selector: 'app-distributorupload',
  templateUrl: './distributorupload.component.html',
  styleUrls: ['./distributorupload.component.scss']
})
export class DistributoruploadComponent implements OnInit {
  ...
  constructor(public db: DatabaseService,public dialog: DialogComponent, public alrt:MatDialog,public dialogRef: MatDialogRef<DistributoruploadComponent>) { }
  ...
  uploadCSV()
  {
      ...
      this.db.fileData(this.formData, 'app_karigar/upload_bulk_distributor_details')
      .subscribe(d => {  
          this.loading = false;
          ...
          if(d['status'] == 'SUCESS'){
              ...
              this.dialog.success('DSR Uploaded Successfully.');
          }
