...
export class DealerAddComponent implements OnInit {
  ...
  getKarigarDetails() {
      ...
      .subscribe(d => {
          ...
          this.assign_dsr_code = this.karigarform.assign_dsr_code;
          console.log(this.assign_dsr_code);
          
          this.karigarform.parent_counter_name = d.karigar.parent_counter_name;
  ...
  getdistributor(){
    this.loading_list = true;
    this.db.post_rqst('', 'app_master/getDistributors')
    .subscribe(d => {  
        this.loading_list = false;  
        console.log(d);
...
//  }
  ...
  dsr_code = '';
 getDsrCode = (val) => {
     console.log('Get DSR Called', val);
     let dsr = this.sales_users.find(x => x.id == val);
     console.log(dsr);
     this.dsr_code = dsr.dsr_code;
 }
  ...
  savekarigarform(form:any)
  {
      ...
      this.karigarform.assign_dsr_code = this.dsr_code;
      this.karigarform.assign_dsr_code = this.assign_dsr_code;
      ...
      console.log('karigar form ->', this.karigarform);
