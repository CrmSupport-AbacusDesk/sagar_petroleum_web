...
export class ReferralMasterComponent implements OnInit {
  ...
  get_refer_detail()
  {
    ...
    .subscribe(resp=>{
      ...
      // this.refer.owner_ref_point = resp['refer_othr_detail'].owner_ref_point;

      this.refer.dealer_points = resp['refer_othr_detail'].dealer_points;
      this.refer.mechanic_points = resp['refer_othr_detail'].mechanic_points;
