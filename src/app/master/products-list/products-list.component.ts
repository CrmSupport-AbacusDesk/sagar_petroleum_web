...
export class ProductsListComponent implements OnInit {
    ...
    getProductList(action) 
    {
        ...
        .subscribe( d => {
            ...
            console.log("this.selected_image====>", this.products.image);
    ...
    getSubCat(event){
        console.log(event);
        this.db.post_rqst({'id':event, 'filter': this.filter}, 'master/subCategoryList')
        .subscribe(d => {  
            console.log(d);
            this.subCategory = d.categories.data;
    ...
    editProduct(id,index){
        ...
        this.productForm.main_category_id=this.productForm.main_category_id;
        this.productForm.category_id=this.productForm.master_category_id;
        console.log(this.productForm.category_id);
        
        if (this.productForm.main_category_id) {
            this.db.post_rqst({'id':this.productForm.main_category_id, 'filter': this.filter}, 'master/subCategoryList')
            .subscribe(d => {  
                console.log(d);
                this.subCategory = d.categories.data;
                console.log(this.subCategory);
