  ...
  category_id: any
    ...
    ngOnInit() {
        this.route.params.subscribe(params => {
            ...
            this.category_nam  =  params['category_name'];
        });
    ...
    savesubcategory(form:any)
    {
        ...
        this.db.insert_rqst( { 'main_category':this.category_id, 'category' : this.category,'created_by':this.db.datauser.id }, 'master/addCategory')
        .subscribe( d => {
            ...
            this.router.navigate(['productsubcatgory/'+this.category_id + '/' + this.category_nam]);
    ...
    getCategoryList()
    {
        ...
        this.db.post_rqst({ 'filter': this.filter, 'id':this.category_id}, 'master/subCategoryList?page=' + this.current_page )
        .subscribe(d => {
            console.log(d);                
            this.loading_list = false;
