...
export class KarigarAddComponent implements OnInit {
    ...
    handleReaderLoaded1(e) {
        ...
        console.log( this.karigarform.document_image_back );
    }
    ...
    handleReaderLoaded2(e) {
        ...
        console.log( this.karigarform.pan_image );
    }
    ...
    sales_list: any = {};
    getSales_list(district) {


        this.filter.district = this.karigarform.district;
        this.filter.limit = 0;
