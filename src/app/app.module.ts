...
import { AddSalesUserComponent } from './master/sale-user/add-sales-user/add-sales-user.component';
import { ListSalesUserComponent } from './master/sale-user/list-sales-user/list-sales-user.component';
import { AssignSlaesComponent } from './assign-slaes/assign-slaes.component';
...
import { BonuslistComponent } from './bonuslist/bonuslist.component';
...
import { DsruploadComponent } from './upload/dsrupload/dsrupload.component';
import { DealeruploadComponent } from './dealer/dealerupload/dealerupload.component';
import { SurveyAddComponent } from './survey/survey-add/survey-add.component';
import { SurveyListComponent } from './survey/survey-list/survey-list.component';
import { SurveyEditModalComponent } from './survey/survey-edit-modal/survey-edit-modal.component';
...
const routes: Routes = [
  ...
  {path: 'visitor/:page', component:VisitorComponent , canActivate: [AuthGuard] },
  ...
  {path: 'add-user', component:AddSalesUserComponent , canActivate: [AuthGuard] },
  {path: 'list-user', component:ListSalesUserComponent , canActivate: [AuthGuard] },
  ...
  {path: 'product-wise', component:ProductreportComponent , canActivate: [AuthGuard]},
...
@NgModule({
  declarations: [
    ...
    MasterTabComponent,
    AddSalesUserComponent,
    ListSalesUserComponent,
    AssignSlaesComponent,
    SystemUserAddComponent,
    SystemUserListComponent,
    BonuslistComponent,
    UploadbonusComponent,
    PdfUploadComponent,
